...
def random_color_masks(image): 
    colors = [[0, 255, 0],[0, 0, 255],[255, 0, 0],[0, 255, 255],[255, 255, 
0],[255, 0, 255],[80, 70, 180], [250, 80, 190],[245, 145, 50],[70, 150, 
250],[50, 190, 190]] 
    r = np.zeros_like(image).astype(np.uint8) 
    g = np.zeros_like(image).astype(np.uint8) 
    b = np.zeros_like(image).astype(np.uint8) 
    r[image == 1], g[image == 1], b[image == 1] = 
colors[random.randrange(0, 10)] 
    colored_mask = np.stack([r, g, b], axis=2) 
    return colored_mask 
 
def instance_segmentation(img_path, threshold=0.5, rect_th=3, text_size=3, 
text_th=3, url=False): 
...
# Assuming the image is uploaded and named "uploaded_image.jpg" 
uploaded_image_path = "/content/qaek94apoucbe5fcrmbw.webp" 
...
img, pred_classes, masks = 
instance_segmentation('/content/qaek94apoucbe5fcrmbw.webp', rect_th=5, 
text_th=4) 
